...
def save_bin(save_dirctory, file_num, data):
    if not os.path.exists(save_dirctory):
        os.makedirs(save_dirctory)
    save_bin_file_name = os.path.join(save_dirctory, f'{file_num}.bin')
...
def save_txt_dict(save_dirctory, file_num, dict):
    if not os.path.exists(save_dirctory):
        os.makedirs(save_dirctory)
    save_txt_file_name = os.path.join(save_dirctory, f'{file_num}.txt')
